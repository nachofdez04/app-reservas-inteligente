...
<head>
  ...
  <style>
    ...
    /* Mejoras en el botón de reservar */
    .btn-reservar {
      transition: all 0.3s ease;
      transform: translateY(0);
    }
    .btn-reservar:hover {
      transform: translateY(-2px);
      box-shadow: 0 5px 15px rgba(44, 160, 247, 0.2);
    }
  </style>
</head>
<body>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function animateCalendarOpen(calendar) {
    calendar.style.animation = 'fadeIn 0.3s ease-out';
  }
  ...
  const fpInstance = flatpickr("#fecha", {
    ...
    onOpen: function(selectedDates, dateStr, instance) {
      animateCalendarOpen(instance.calendarContainer);
    },
  ...
  document.addEventListener('click', function(e) {
    ...
    // Si se hace clic fuera del input y del calendario, quitar la clase focused-input
    if (fechaInput && !fechaInput.contains(e.target) && 
        (!calendar || (calendar && !calendar.contains(e.target)))) {
      fechaInput.parentElement.classList.remove('focused-input');
    }
  });
...
<script src="js/cargarPlazas.js"></script>
